...
import com.ti.connectivity.simplelinkconnect.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
         ...
         */
        Class<?> aClass = Class.forName("com.ti.connectivity.simplelinkconnect.ReactNativeFlipper");
        aClass
