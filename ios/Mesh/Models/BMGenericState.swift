...
struct BMGenericState<T: Equatable> {
    ...
    init(transitionFrom state: BMGenericState<T>, to targetValue: T,
    ...
    init(continueTransitionFrom state: BMGenericState<T>, to targetValue: T,
         delay: TimeInterval, duration: TimeInterval?,
         storedWithScene: Bool = false) {
        self.animation = nil
        self.storedWithScene = storedWithScene
...
extension BMGenericState where T: BinaryInteger {
    ...
    init(animateFrom state: BMGenericState<T>, to targetValue: T,
         delay: TimeInterval, duration: TimeInterval?,
         storedWithScene: Bool = false) {
        self.value = state.value
        self.transition = nil
